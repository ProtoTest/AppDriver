...
public class Element extends WebElement {
    ...
    public Verification verify() {
        return new Verification(this, getConfig().elementTimeoutSec);
    }

//    public WaitUntil waitUntil() {
//
//        return new WaitUntil(this, getConfig().elementTimeoutSec);
//    }
    ...
    public WebElement getElement() {
        ...
        List<WebElement> elements = getDriver().findElements(this.by);
    ...
    public Element waitUntilVisible() {
        WebDriverWait wait = new WebDriverWait((org.openqa.selenium.WebDriver) getDriver(), 10);
